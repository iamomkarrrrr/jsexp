...
const browserVersionElement = 
document.getElementById('browserVersion'); 
const userAgent = navigator.userAgent; const browserInfo =
userAgent.match(/(firefox|msie|chrome|safari|opr|edg|brave)\/?\s*(\d+)/i) ||
[];
const browserName = browserInfo[1];
const browserVersion = browserInfo[2];
browserNameElement.innerText = browserName ?
browserName.charAt(0).toUpperCase() + browserName.slice(1) : "Unknown"; 
